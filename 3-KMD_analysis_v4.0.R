...
## Input data
sample.list <- "sample_list_KMD_LNAPL_and_JerryCan_1.csv"
feat.files <- "featureGroupsXCMS_LNAPL_JerryCan_07312024.txt"# is an input but is on an output folder
...
int_tresh <- 10 # intensity or area count threshold 
